 ...
 * Addresses and ABI for EscrowManager and USDC
 */
...
export const ESCROW_ABI = [
  // Events
  { anonymous: false, inputs: [{ indexed: true, internalType: "uint256", name: "leaseId", type: "uint256" }, { indexed: false, internalType: "address", name: "landlord", type: "address" }, { indexed: false, internalType: "address", name: "tenant", type: "address" }, { indexed: false, internalType: "string", name: "cid", type: "string" }], name: "LeaseInitialized", type: "event" },
